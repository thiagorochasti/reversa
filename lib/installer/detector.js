...
export const ENGINES = [
  ...
  },
  {
    ...
    name: 'OpenClaude',
    star: false,
    entryFile: 'OPENCLAUDE.md',
    entryTemplate: 'OPENCLAUDE.md',
    skillsDir: '.claude/skills',
    universalSkillsDir: '.agents/skills',
  },
  {
    ...
    name: 'DeepSeek',
    star: false,
    entryFile: 'DEEPSEEK.md',
    entryTemplate: 'DEEPSEEK.md',
    skillsDir: '.agents/skills',
    universalSkillsDir: '.agents/skills',
  },
  {
...
export function detectEngines(projectRoot) {
  const detectors = {
    ...
    'openclaude':     (r) => existsSync(join(r, '.openclaude')) || existsSync(join(r, 'OPENCLAUDE.md')) || commandExists('openclaude'),
    'deepseek':       (r) => existsSync(join(r, '.deepseek')) || existsSync(join(r, 'DEEPSEEK.md')) || commandExists('deepseek'),
    'qwen':           (r) => existsSync(join(r, '.qwen')) || existsSync(join(r, 'QWEN.md')) || commandExists('qwen'),
  };
